-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'VENTAS', 'BODEGA', 'COMPRAS');
...
CREATE TABLE "users" (
    ...
    "role" "UserRole" NOT NULL DEFAULT 'BODEGA',
...
-- CreateIndex
CREATE UNIQUE INDEX "stock_levels_variantId_warehouseId_key" ON "stock_levels"("variantId", "warehouseId");
